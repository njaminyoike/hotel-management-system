...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const texts = [
        ...
        "Savor the blend of tradition and innovation at our Restaurant, where each dish is a masterpiece crafted with passion and expertise.",
        ...
        "Experience the essence of fine dining at this Restaurant, where every meal tells a story of dedication to quality and culinary excellence.",
